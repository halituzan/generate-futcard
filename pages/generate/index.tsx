...
const DrawingBoard: React.FC = () => {
    ...
    const handleMouseDown = (
        ...
        if (rect) {
            ...
            const rightHandle = width - mouseX <= resizeHandleSize;
            const topHandle = mouseY <= resizeHandleSize;
        ...
        if (dragging) {
            ...
            if (rect) {
                ...
                if (resizing) {
                    ...
                    setWidth(Math.max(width + deltaX, 50)); // Minimum width is 50
                    setHeight(Math.max(height - deltaY, 50)); // Minimum height is 50
                } else {
    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            />
            <div className="mt-10">
                <button className="bg-red-600 rounded-md p-2" onClick={handleSaveImage}>Save Image</button>
            </div>
        </div>
    );
};
